...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of IHEqualizerView.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/mdibrahimhassan@gmail.com/IHEqualizerView'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'mdibrahimhassan@gmail.com' => 'mdibrahimhassan@gmail.com' }
  s.source           = { :git => 'https://github.com/mdibrahimhassan@gmail.com/IHEqualizerView.git', :tag => s.version.to_s }
